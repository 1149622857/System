package com.example.system.socketnetwork;
...
public abstract class TcpClient implements Runnable {
	...
	public void run() {
		...
		//	SocketAddress socketAddress = new InetSocketAddress(inetAddress, port);
			...
			Log.e("scoket","inetaddress"+socket.getInetAddress());
			Log.e("scoket","getLocalPort"+socket.getLocalPort());
			Log.e("scoket","getLocalAddress"+socket.getLocalAddress());
			Log.e("scoket","getLocalSocketAddress"+socket.getLocalSocketAddress());
			Log.e("scoket","getPort"+socket.getPort());
